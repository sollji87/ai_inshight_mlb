      ...
      <div className="container">
        ...
        <div className="left">
          ...
          <div className="section">
            ...
            <table>
              <thead>
                <tr><th>#</th><th>매장</th><th>채널</th><th className="num">직접이익</th><th className="num">이익률</th></tr>
              </thead>
              <tbody>
                <tr className="success-row"><td>1</td><td>명동중앙</td><td>플래그쉽</td><td className="num">589</td><td className="num">45.5%</td></tr>
                <tr><td>2</td><td>롯데면세소공</td><td>면세</td><td className="num">547</td><td className="num">30.8%</td></tr>
                <tr><td>3</td><td>무신사</td><td>제휴몰</td><td className="num">519</td><td className="num">42.1%</td></tr>
                <tr><td>4</td><td>현대면세무역</td><td>면세</td><td className="num">397</td><td className="num">31.1%</td></tr>
                <tr><td>5</td><td>신라면세용산</td><td>면세</td><td className="num">372</td><td className="num">26.4%</td></tr>
              </tbody>
            </table>
          ...
          <div className="section">
            ...
            <table>
              ...
              <tbody>
                ...
                <tr className="warn-row"><td>광고비</td><td className="num">696</td><td className="num text-red">161%</td><td>브랜드 투자</td></tr>
                <tr className="success-row"><td>지급수수료</td><td className="num">116</td><td className="num text-green">44%</td><td>구조 효율화</td></tr>
                <tr><td>자가임차료</td><td className="num">280</td><td className="num text-red">217%</td><td>성수 신규</td></tr>
                <tr><td>감가상각비</td><td className="num">145</td><td className="num">124%</td><td>인테리어</td></tr>
        ...
        <div className="right">
          ...
          <div className="section">
            ...
            <div className="box box-red">
              ...
              <table>
                <thead>
                  <tr><th>매장</th><th>채널</th><th className="num">직접이익</th><th className="num">매출YoY</th><th className="num">할인율↑</th></tr>
                </thead>
                <tbody>
              ...
              <ul style={{ marginTop: "3px" }}>
                <li>3개 매장 클로징 시 연간 <b>96백만원</b> 손실 방지</li>
            ...
            <div className="box box-yellow">
              ...
              <ul style={{ marginTop: "3px" }}>
                <li>할인율 5% 이내 목표 → 연간 <b>120백만원</b> 개선</li>
              </ul>
            </div>
            ...
            <div className="box box-green">
              ...
              <table>
                <thead>
                  <tr><th>매장</th><th className="num">직접이익</th><th className="num">매출YoY</th><th>상태</th></tr>
                </thead>
                <tbody>
                  <tr className="success-row"><td>스타필드하남</td><td className="num">11</td><td className="num">+28.3%</td><td><span className="badge-up">회복</span></td></tr>
                  <tr className="success-row"><td>갤러리아광교</td><td className="num">12</td><td className="num">+24.4%</td><td><span className="badge-up">정상화</span></td></tr>
                  <tr className="success-row"><td>신세계경기</td><td className="num">5</td><td className="num">+31.8%</td><td><span className="badge-up">회복</span></td></tr>
                  <tr><td>롯데광주</td><td className="num">7</td><td className="num">+7.5%</td><td><span className="badge-warn">관찰</span></td></tr>
                  <tr><td>동성로</td><td className="num">3</td><td className="num">+7.7%</td><td><span className="badge-warn">관찰</span></td></tr>
                  <tr><td>스타필드수원</td><td className="num">3</td><td className="num text-red">-8.8%</td><td><span className="badge-warn">관찰</span></td></tr>
                  <tr><td>롯데대구</td><td className="num">5</td><td className="num text-red">-20.1%</td><td><span className="badge-warn">관찰</span></td></tr>
                </tbody>
              </table>
              <ul style={{ marginTop: "3px" }}>
            ...
            <div className="insight-box">
              ...
              <table>
                ...
                <tbody>
                  <tr><td>클로징</td><td className="num">3개</td><td className="num">8</td><td className="num">96</td></tr>
                  <tr><td>할인율 조정</td><td className="num">4개</td><td className="num">10</td><td className="num">120</td></tr>
                  <tr><td>상품믹스</td><td className="num">5개</td><td className="num">25</td><td className="num">300</td></tr>
                  <tr className="total-row"><td><b>합계</b></td><td className="num"><b>12개</b></td><td className="num"><b>43</b></td><td className="num"><b>516</b></td></tr>
                </tbody>
              </table>
            </div>
          </div>
